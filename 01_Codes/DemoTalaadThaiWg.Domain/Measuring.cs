...
namespace DemoTalaadThaiWg.Domain
{
    public class Measuring : HwEntity
    {
        ...
        public string LicensePlateNo
        {
            ...
            private set { licensePlateNo = value; }
        }
        ...
        public void SetLicensePlate(string iLicensePlate)
        {
            LicensePlateNo = iLicensePlate;
        }
        ...
        public virtual void AddItem(MeasuringMoveItem item)
        {
            if (Status != MeasuringStatus.Draft)
                throw new DomainException(string.Format(DemoTalaadThaiWg.Domain.Resources.Message.MSG_ACTION_STATUS_ONLY, MeasuringStatus.Draft.ToString()));
        ...
        public void PrepareRemove()
        {
            if (!string.IsNullOrEmpty(No))
                throw new DomainException(DemoTalaadThaiWg.Domain.Resources.Message.MSG_CANNOT_REMOVE_HAS_NO);
