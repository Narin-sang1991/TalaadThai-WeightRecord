...
namespace DemoTaladThaiWg.Shell.ViewModels
{
        ...
        where I : MeasuringMoveItemData
    {
        ...
        public string ReferenceNo
        {
            ...
            protected set
            {
                ...
                if (!string.IsNullOrWhiteSpace(value))
                    this.Type = MeasuringMoveType.Out;
        ...
        protected override void LoadOriginalSource(T originalSource)
        {
            ...
            this.LicensePlateNo = originalSource.LicensePlateNo;
        ...
        protected override void SaveOriginalSource(T originalSource)
        {
            ...
            originalSource.LicensePlateNo = this.LicensePlateNo;
