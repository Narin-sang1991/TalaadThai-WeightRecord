...
namespace Cet.EntityFramework.Adaptor
{
         ...
         where TEntity : class
    {
        ...
        public static Specification<TEntity> operator &(Specification<TEntity> leftSideSpecification, Expression<Func<TEntity, bool>> rightSideSpecification)
        {
            return new AndSpecification<TEntity>(leftSideSpecification, new DirectSpecification<TEntity>(rightSideSpecification));
        }
        ...
        public static Specification<TEntity> operator |(Specification<TEntity> leftSideSpecification, Expression<Func<TEntity, bool>> rightSideSpecification)
        {
            return new OrSpecification<TEntity>(leftSideSpecification, new DirectSpecification<TEntity>(rightSideSpecification));
        }
        /// <summary>
        /// Not specification
        /// </summary>
        ...
        [global::System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Usage", "CA1801:ReviewUnusedParameters", MessageId = "specification")]
